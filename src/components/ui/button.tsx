    ...
    variants: {
      variant: {
        default:
           ...
           "bg-primary text-primary-foreground border border-primary-border shadow-[0_8px_18px_hsl(161_55%_34%/0.18)]",
        destructive:
        ...
        outline:
          ...
          // No hover state
          " border bg-card/80 [border-color:var(--button-outline)] shadow-sm active:shadow-none backdrop-blur ",
        secondary:
